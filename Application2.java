...
public class Application2 {
	...
	public static void main(String args[]){
		...
		System.out.print("n= ");
		int on = an.nextInt();
		System.out.print( "Factorial("+on+")= " + ap.factorial(on));
		System.out.println("\n\nQ3 - Combinations (n, k)");
		System.out.print("n= ");
		int n = an.nextInt();
		System.out.print("k= ");
		int k = an.nextInt();
		System.out.print("Combinations ("+n+","+k+") =" +ap.combinations (n,k) );
		System.out.println("\n\nQ4 - Number of digits");
		System.out.println("Enter a positive integer:");
		System.out.print("n=");
		int q = an.nextInt();
		System.out.print("Number of digits ="+ ap.digitsOfInteger(q));
		...
		System.out.println ("The area of a triangle is: "+ap.findArea (p,o,j) );
		System.out.println("\n\nQ7 - Reverse digits ");
		System.out.println("Enter a positive integer: ");
		System.out.print("n= ");
		int x = an.nextInt();
		...
		int r = an.nextInt();
		System.out.println("Min Digit = " +ap.minDigit(r) );
	}	
}
